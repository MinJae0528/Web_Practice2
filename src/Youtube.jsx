            ...
            <div className="MainContainer">
                ...
                <main className="MainView">
                    <div className="HeaderButton">
                        ...
                        <button className="MusicButton">음악</button>
                        <button className="GameButton">게임</button>
                        <button className="NewsButton">뉴스</button>
                        <button className="LiveButton">라이브</button>
                        <button className="FoodButton">요리</button>
                        <button className="RecentlyUploadVideoButton">최근에 업로드된 동영상</button>
                        <button className="WatchedVideoButton">감상한 동영상</button>
                        <button className="NewCustomVideoButton">새로운 맞춤 동영상</button>
                    </div>
